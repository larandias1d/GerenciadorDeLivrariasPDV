...
public class PedidoDAO {
	...
	public void Cadastrar (Pedido pedido) {
		...
		try {
			...
			System.out.println(pedido.getIdClienteJuridico());
...
// ITENS DO PEDIDO
	...
	/*public double obterTotal (int codVenda) {
		...
		try {
			...
			while (rs.next()) {
				...
				ItensPedidos itensPedidos = new ItensPedidos ();
				itensPedidos.setCodLivro(rs.getInt("codLivro"));
				itensPedidos.setQuantidade(rs.getInt("quantidade"));
				livroDAO.Consultar(livro, itensPedidos.getCodLivro());
